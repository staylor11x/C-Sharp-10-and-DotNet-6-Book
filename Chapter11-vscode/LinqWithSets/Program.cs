...
string[] cohort1 = new[] { "Rachael", "Gareth","Jonathan","George"};
...
Output(cohort1.Zip(cohort2,(c1,c2) => $"{c1} matched with {c2}"), "cohort1.Zip(cohort2)");  //those without a match will not be included in the result
